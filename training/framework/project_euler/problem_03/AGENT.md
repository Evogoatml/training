...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_03` |
| **Agent ID** | `2f5d25be` |
...
- **`sol1.py`** — 890 B, modified 2026-04-23
- **`sol2.py`** — 364 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_03")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("2f5d25be")
```
