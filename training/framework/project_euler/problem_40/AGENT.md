...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_40` |
| **Agent ID** | `8ebfcaea` |
...
- **`sol1.py`** — 707 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_40")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("8ebfcaea")
```
