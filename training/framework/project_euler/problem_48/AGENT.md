...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_48` |
| **Agent ID** | `dc43d237` |
...
- **`sol1.py`** — 320 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/framework/project_euler/problem_48")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("dc43d237")
```
