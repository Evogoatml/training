...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/framework/Translator` |
| **Agent ID** | `e1e60897` |
...
- **`README.md`** — 255 B, modified 2026-04-23

#### `.py` (1 files)

- **`translator.py`** — 1.6 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/framework/Translator")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("e1e60897")
```
