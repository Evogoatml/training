...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/other/Text Editor` |
| **Agent ID** | `4c441348` |
...
- **`README.md`** — 763 B, modified 2026-04-23

#### `.py` (1 files)

- **`main.py`** — 3.6 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/other/Text Editor")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("4c441348")
```
