...
| Field | Value |
|---|---|
| **Folder** | `core/reasoning/brain/knowledge/algorithms/other/DiscordVCBot` |
| **Agent ID** | `0e86de5a` |
...
- **`dynamic_vc_bot.py`** — 14.6 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/reasoning/brain/knowledge/algorithms/other/DiscordVCBot")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("0e86de5a")
```
